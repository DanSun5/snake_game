...
#__________________________________GAME OVER BY BOX 
    if x < 0 or x >= GAME_WIDTH:
        return True
    elif y < 0 or y >= GAME_HIGHT:
        return True
    
#__________________________________GAME OVER BY SNAKE BODY 
...
canvas = Canvas(window, bg=BAKEGROUND_COLOR, height=GAME_HIGHT, width=GAME_WIDTH)
canvas.pack()
